...
// import AnimatedText from "./scramnling";
...
//             <AnimatedText className="bg-yellow-500 max-w-[54vw] flex flex-wrap h-full">
...
import { useEffect } from "react";
import StarCanvas from "@/components/starcanvass";
import AnimatedText from "@/components/scramnling";
...
export default function Hero() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      >
        <motion.h1
          className="text-6xl text-white font-bold mb-10"
          initial={{ scale: 0, opacity: 0, y: -4 }}
          animate={{ opacity: 1, scale: 1, height: 2, rotateY: 360, y: 0 }}
          transition={{
            type: "spring",
        ...
        <div className="max-w-3xl text-center m-8">
          <AnimatedText className="text-white text-xl">
            Welcome to Cryptoverse, your gateway to the crypto universe. Track
            real-time prices, analyze market trends, and explore thousands of
            digital currencies all in one place. Stay ahead with live updates
            and make informed decisions in the ever-evolving world of
